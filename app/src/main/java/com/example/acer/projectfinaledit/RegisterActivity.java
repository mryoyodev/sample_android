...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.buttonRegisterEmail).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void registerUserEmail() {
        ...
        class RegisterUserEmail extends AsyncTask<Void, Void, String> {
        ...
        RegisterUserEmail ru = new RegisterUserEmail();
        ru.execute();
